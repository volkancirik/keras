...
def split(split_dim, num_split, x):
	'''Splits a tensor into num_split tensors along one dimension.
	See : https://www.tensorflow.org/versions/r0.11/api_docs/python/array_ops.html#split
	'''
	return tf.split(split_dim, num_split, x)

def range_(start, limit = None, delta = 1, name = 'range'):
	return tf.range(start, limit = limit, delta = delta, name = name)
